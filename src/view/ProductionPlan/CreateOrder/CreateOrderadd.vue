<template>
  <div>
    ...
    <el-page-header @back="goBack" content="新增通知单"> </el-page-header>
     <div class="warp">
    <div class="resulting">
    ...
    <div class="picklisttable">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="印刷工序" name="first" :key="'first'">
          <CreateOrderTabsFirst :data="data" :monthname="monthname" ref="CreateOrderTabsFirst"></CreateOrderTabsFirst>
        </el-tab-pane>
        <el-tab-pane label="烫金工序" name="second" :key="'second'">
          <CreateOrderTabsSecond :data="data" :monthname="monthname" ref="CreateOrderTabsSecond"></CreateOrderTabsSecond>
        </el-tab-pane>
        <el-tab-pane label="分切工序" name="third" :key="'third'">
          <CreateOrderTabsThird :data="data" :monthname="monthname" ref="CreateOrderTabsThird"></CreateOrderTabsThird>
        </el-tab-pane>
        <el-tab-pane label="打孔工序" name="fourth" :key="'fourth'">
          <CreateOrderTabsFourth :data="data" :monthname="monthname" ref="CreateOrderTabsFourth"></CreateOrderTabsFourth>
        </el-tab-pane>
        <el-tab-pane label="复卷工序" name="five" :key="'five'">
          <CreateOrderTabsFive :data="data" :monthname="monthname" ref="CreateOrderTabsFive"></CreateOrderTabsFive>
        </el-tab-pane>
      </el-tabs>
    </div>
    <el-row class="row">
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        ...
        if(this.monthname != ""){
          var subData = {'name':this.monthname,'unit':'t','detaileds':submitData};
        noticeInsert(subData).then((res) => {
           this.$message({
              message: "添加成功",
              type: "success",
            });
