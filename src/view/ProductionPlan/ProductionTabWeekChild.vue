...
<script>
import {weekgetPage,monthWeekupdateWeekdelete} from "../../api"
export default {
  data () {
    return {
       currentPage: 1, //当前页
  ...
  methods: {
    ...
    handleExport(index,row){
      location.href = `http://192.168.1.36:8000/api/production/monthWeek/exportData?monthId=${row.id}`
    },
    onSearch() {
        var queryStartDate = "";
        var queryEndDate = "";
