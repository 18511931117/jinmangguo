<template>
  <div>
    <el-page-header @back="goBack" content="周计划编辑"> </el-page-header>
    <div class="warp">
    <div class="resulting">
...
import {
  ...
  processgetPage,
  devicegetAll,
  monthWeekgetWeekPlan,
  monthWeekupdateWeekPlanDetail
} from "../../../api";
export default {
  // components: {
  ...
  methods: {
    ...
    getIdData(){
      monthWeekgetWeekPlan({
        ...
        this.monthname = res.data.data.productionPlanWeek.name
        this.data = [res.data.data.productionPlanWeek.startDate,res.data.data.productionPlanWeek.endDate]
        this.tableData = res.data.data.weekDataList
      })
    },
    onSubmit() {},
    selectId(val) {
      this.getSelectCode(val.split("-")[0]);
    },
    getSelectData() {
