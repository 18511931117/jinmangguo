...
export default {
  ...
  methods: {
    getIdData() {
      getDtoBom(this.$route.query.id).then((res) => {
        
        this.code = res.data.data.code
        this.productId = String(res.data.data.productId)
        this.tableData2 = res.data.data.materiels
        // this.tableData = res.data.data.materiels
      });
    },
