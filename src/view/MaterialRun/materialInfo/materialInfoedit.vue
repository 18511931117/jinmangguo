...
<script>
import { infoEdit,infoEditSubmit,typegetAll} from "../../../api";
export default {
  data() {
    return {
      infoFrom: {
      ...
      rules: {
       ...
       /* spellNum: [{ required: true, message: "请输入盘数", trigger: "blur" }],
        basePaperLength: [
          { required: true, message: "请输入原纸长度", trigger: "blur" },
        ],
        basePaperThickness: [
          { required: true, message: "请输入原纸宽度", trigger: "blur" },
        ],
        basePaperGram: [
          { required: true, message: "请输入原纸克重", trigger: "blur" },
        ],*/
  ...
  methods: {
    ...
    getIdData(){
        infoEdit(this.$route.query.id).then(res =>{
            ...
            this.infoFrom.spellNum = res.data.data.spellNum
            this.infoFrom.basePaperLength = res.data.data.basePaperLength
            this.infoFrom.basePaperThickness = res.data.data.basePaperThickness
            this.infoFrom.basePaperGram = res.data.data.basePaperGram
            this.infoFrom.specs = res.data.data.specs
            this.infoFrom.consume = res.data.data.consume
            this.infoFrom.manufactor = res.data.data.manufactor
            this.infoFrom.typeId = String(res.data.data.typeId)
            this.infoFrom.mainCompany = res.data.data.mainCompany
            this.infoFrom.mainCompanyRatio = res.data.data.mainCompanyRatio
            this.infoFrom.viceCompany = res.data.data.viceCompany
            this.infoFrom.viceCompanyRatio = res.data.data.viceCompanyRatio
        })
    },
    onSubmit(infoFrom) {
