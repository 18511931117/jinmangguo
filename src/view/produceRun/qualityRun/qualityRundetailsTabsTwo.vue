  ...
  <div class="warp">
    ...
    <div class="vxe_table">
      ...
      >
        ...
        ></vxe-table-column>
        <vxe-table-column field="num1" title="判定" width="250">
    ...
    return {
      ...
      tableData: [
       ...
       mergeCells: [
        ...
        { row: 32, col: 1, rowspan: 1, colspan: 1 },
         { row: 32, col: 3, rowspan: 1, colspan: 2 },
        { row: 33, col: 0, rowspan: 1, colspan: 6 },
        { row: 34, col: 0, rowspan: 1, colspan: 3 },
        { row: 34, col: 3, rowspan: 1, colspan: 3 },
