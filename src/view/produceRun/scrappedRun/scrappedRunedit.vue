  ...
  <div>
    ...
    <div class="resulting2">
      ...
      <el-table ref="multipleTable" :data="tableData2" style="width: 100%">
        ...
        <!--<el-table-column prop="viceUnit" label="数量" show-overflow-tooltip>
        </el-table-column>-->
...
<script>
import { scrapgetAll, productioninfogetPage,scrapinsertScrap,scrapgetDto,scrapupdateScrap } from "../../../api";
export default {
  data() {
    return {
      currentPage: 1, //当前页
  ...
  methods: {
    ...
    getIdData(){
      scrapgetDto(this.$route.query.id).then(res => {
